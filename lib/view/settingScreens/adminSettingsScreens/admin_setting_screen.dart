              ...
              () => !profileController.loadingGetAdminProfile.value ||
                  ...
                  ? Column(
                      children: [
                        CircleAvatar(
                          radius: 5.h,
                          backgroundColor: profileController.getAdminProfile
                                      .value!.data!.user!.color ==
                                  null
                              ? CustomColors.hintColor
                              : profileController
                                  .getAdminProfile.value!.data!.user!.color!
                                  .toColor(),
                          child: customWhiteMediumText(
                            text: profileController
                                .getAdminProfile.value!.data!.user!.initials
                                .toString()
                                .toUpperCase(),
                            fontSize: 18.sp,
                          ),
                        ...
                        customWhiteMediumText(
                            text: profileController
                                .getAdminProfile.value!.data!.user!.fullName
                                .toString(),
                            fontSize: 16.sp),
                        customWhiteMediumText(
                            text: profileController
                        ...
                        GestureDetector(
                          onTap: () => Get.to(() => EditYourNameScreen(
                                fullName: profileController
                                    .getAdminProfile.value!.data!.user!.fullName
                                    .toString(),
                                initialColor: profileController.getAdminProfile
                                        .value!.data!.user!.color ??
                                    '#C1C1C1',
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => customWhiteMediumText(
                                      text: DataFile.selectedLanguage.value
                                          .toString()
                                          .tr,
                                      fontSize: 14.sp,
                                      fontFamily: Constant.fontsFamilyRegular,
